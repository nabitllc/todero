 ...
 */
export const SANDBOX_STARTUP_SPAN_ATTR_PREFIX = "todero.sandbox.startup.";
 ...
 * the `todero.sandbox.startup.` prefix and a type suffix:
 *
 ...
 * `todero.sandbox.startup.` allowlist. It records the wall, work, and diff

/**
 * `@todero/plugin-sdk/ui` — Todero plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@todero/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@todero/plugin-sdk/ui";
 *
 ...
 * - `useHostNavigation()` — navigate Todero-internal links through the host router

/**
 * Todero plugin UI SDK — types for plugin frontend components.
 *
 * Plugin UI bundles import from `@todero/plugin-sdk/ui`.  This subpath
...
/**
 * Options for host-managed Todero navigation from plugin UI.
 */
...
export interface HostNavigation {
  /**
   * Resolve a Todero-internal path using the active company prefix.
   *

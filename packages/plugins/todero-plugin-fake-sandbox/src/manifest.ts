...
const PLUGIN_ID = "todero.fake-sandbox-provider";
...
const manifest: PaperclipPluginManifestV1 = {
  ...
  description:
    "First-party deterministic sandbox provider plugin for exercising Todero provider-plugin integration without external infrastructure.",
  author: "Todero",

...
const MANAGED_AGENT = {
  ...
  resourceKey: "todero.plugin-llm-wiki:agent:wiki-maintainer",
...
const MANAGED_PROJECT = {
  ...
  resourceKey: "todero.plugin-llm-wiki:project:llm-wiki",
...
const MANAGED_ROUTINE = {
  ...
  resourceKey: "todero.plugin-llm-wiki:routine:nightly-wiki-lint",
  routine: {
    id: "rtn-llmw-night",
...
const MANAGED_ROUTINES = [
  {
    ...
    resourceKey: "todero.plugin-llm-wiki:routine:cursor-window-processing",
    routine: {
      id: "rtn-llmw-cursor",
  ...
  MANAGED_ROUTINE,
  {
    ...
    resourceKey: "todero.plugin-llm-wiki:routine:index-refresh",
    routine: {
      id: "rtn-llmw-index",
...
const MANAGED_SKILL = {
  ...
  details: {
    ...
    key: "plugin/todero-plugin-llm-wiki/wiki-maintainer",
    description: "Use the LLM Wiki plugin tools to maintain a cited local company wiki.",
  },
};
const MANAGED_SKILLS = [
  MANAGED_SKILL,
  { status: "resolved", skillId: "skl-llmw-ingest", resourceKey: "wiki-ingest", details: { name: "Wiki Ingest", key: "plugin/todero-plugin-llm-wiki/wiki-ingest", description: null } },
  { status: "resolved", skillId: "skl-llmw-query", resourceKey: "wiki-query", details: { name: "Wiki Query", key: "plugin/todero-plugin-llm-wiki/wiki-query", description: null } },
  { status: "resolved", skillId: "skl-llmw-lint", resourceKey: "wiki-lint", details: { name: "Wiki Lint", key: "plugin/todero-plugin-llm-wiki/wiki-lint", description: null } },
  { status: "resolved", skillId: "skl-llmw-distill", resourceKey: "todero-distill", details: { name: "Todero Distill", key: "plugin/todero-plugin-llm-wiki/todero-distill", description: null } },
  { status: "resolved", skillId: "skl-llmw-index", resourceKey: "index-refresh", details: { name: "Index Refresh", key: "plugin/todero-plugin-llm-wiki/index-refresh", description: null } },
];
...
const PAGES = {
  ...
  sources: [
    ...
    { rawPath: "raw/todero-v1-spec.md", title: "Todero V1 spec", sourceType: "file", url: null, status: "captured", createdAt: "2026-05-01T18:30:00Z" },
...
A **plugin-managed resource** is a normal Todero resource (agent, routine, project) that a plugin has seeded with suggested defaults. The plugin marks ownership via a stable \`resourceKey\` so that installs, imports, and upgrades can find the resource even when UUIDs differ.
...
`,
  ...
  sourceRefs: ["raw/karpathy-llm-wiki.md", "raw/todero-v1-spec.md"],
...
const OPERATIONS = {
  operations: [
    ...
    { id: "2939ffffffff", operationType: "ingest", status: "done", hiddenIssueId: "ii-2939", hiddenIssueIdentifier: "PAP-OP-2939", hiddenIssueTitle: "todero-v1-spec.md · 3 pages created", hiddenIssueStatus: "done", projectId: "prj-llmw-7e1a", costCents: 2, warnings: [], affectedPages: [{ path: "wiki/areas/control-plane.md" }, { path: "wiki/concepts/managed-resources.md" }, { path: "wiki/concepts/origin-kind.md" }], createdAt: "2026-05-01T18:30:00Z", updatedAt: "2026-05-01T18:32:00Z" },
...
You maintain this wiki through Todero plugin tools.
...
(globalThis as { __toderoPluginBridge__?: { sdkUi?: Record<string, unknown> } }).__toderoPluginBridge__ = { sdkUi };

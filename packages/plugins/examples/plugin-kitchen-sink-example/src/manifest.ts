...
const manifest: PaperclipPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Todero plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Todero",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Todero domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },

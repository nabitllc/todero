...
const PLUGIN_ID = "todero.e2b-sandbox-provider";
...
const manifest: PaperclipPluginManifestV1 = {
  ...
  description:
    "First-party sandbox provider plugin that provisions E2B cloud sandboxes as Todero execution environments.",
  author: "Todero",
      ...
      configSchema: {
        ...
        properties: {
          ...
          apiKey: {
            ...
            format: "secret-ref",
            description:
              "Environment-specific E2B API key. Paste a key or an existing Todero secret reference; saved environments store pasted values as company secrets. Falls back to E2B_API_KEY if omitted.",
          },
          timeoutMs: {
            type: "number",
            description:

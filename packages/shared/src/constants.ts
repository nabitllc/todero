...
// Config keys owned by Todero/company state rather than one concrete adapter.
// `toderoSkillSync` is persisted in adapterConfig but must survive adapter swaps.
 ...
 * Todero UI where plugin components can be rendered.
 *

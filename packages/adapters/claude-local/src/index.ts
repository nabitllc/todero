...
- stateDir (string, optional): ACP session state directory; defaults to Todero-managed company/agent scoped storage
...
- For ACP runs, model selection is passed through ANTHROPIC_MODEL at ACP server startup; Todero-managed Claude permissions and ephemeral skill materialization are handled by the shared ACP engine.

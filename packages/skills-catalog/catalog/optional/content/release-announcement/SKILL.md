...
key: todero/optional/content/release-announcement
recommendedForRoles:
  - devrel
  - product
  - writer
...
When this skill runs inside Todero and `experimental.enableCases` is enabled,
...
Use `skills/todero/references/cases.md` for the API contract. Include
`X-Todero-Run-Id` on writes when `PAPERCLIP_RUN_ID` is set. If the API returns
...
{
  "caseType": "blog_post",
  "key": "todero-release:vYYYY.MDD.P:blog-post",
  "title": "Todero vYYYY.MDD.P launch post",
  "status": "in_review",
  "parentCaseId": "<release-case-id>",
  "fields": {
    "schema_version": 1,
    "version": "vYYYY.MDD.P",
    "slug": "todero-vYYYY-MDD-P",

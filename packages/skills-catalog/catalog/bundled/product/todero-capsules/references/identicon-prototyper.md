...
Use this reference when generating or reviewing deterministic Todero capsule identicons/profile pills. Prototype source paths, when the Todero content repository is available:

- `todero-content/design/PAP-11825/todero-capsule-identicon-prototyper/README.md`
- `todero-content/design/PAP-11825/todero-capsule-identicon-prototyper/src/identicon.ts`
- `todero-content/design/PAP-11825/todero-capsule-identicon-prototyper/src/App.tsx`

...
- [ ] `npm view todero@canary version` matches the expected canary
...
- [ ] `npm view todero@nightly version` shows the new `-nightly.N`
...
- [ ] `npm view todero@beta version` shows the new `-beta.N`
...
- [ ] `npm view todero version` (dist-tag `latest`) shows the stable

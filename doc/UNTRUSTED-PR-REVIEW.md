...
This is intentionally separate from the normal Todero dev image.
...
```sh
review-checkout-pr nabitllc/todero 432
cd /work/checkouts/todero-todero/pr-432
```
...
## Preview the Todero app from the PR
...
- Todero's embedded PostgreSQL and local storage stay inside the container home volume via `PAPERCLIP_HOME=/home/reviewer/.todero-review`.

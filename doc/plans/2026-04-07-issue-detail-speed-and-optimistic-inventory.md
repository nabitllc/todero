...
This note inventories the Todero issues that point to the same UX class of problem:
...
Pattern: Todero already has several places where the right fix was "show intent immediately, then reconcile," not "wait for refetch."

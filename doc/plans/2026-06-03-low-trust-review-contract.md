...
3. Todero copies that output into a higher-trust assignee wake
...
- Repo workspace content itself remains hostile; this contract narrows Todero API authority, not the semantic risk of reading bad code.

...
description: >
  Write the Discord announcement for a stable Todero release from the release
...
Write the Discord release announcement for the **stable** Todero release.
...
current Todero work — not invented.
...
Use Discord emoji shortcodes (`:todero:`, `:lock:`, `:brain:` …) — NOT the
Unicode emoji. Discord renders the shortcodes; the changelog file uses prose.

```
:todero: :todero: :todero: CLIPPERS!!! v{VERSION} IS OUT :todero: :todero: :todero:

OFFICIAL TWITTER: https://x.com/toderoing - follow it, report any others
...
FOLLOW THE TWITTER: https://x.com/toderoing - that's the only official one
TELL ME if you're using Todero in your business - I want to meet you
...
thousand agents and Todero will be the default tool to manage it all.

ITS TIME TO CLIP :todero: :todero: :todero:

FULL RELEASE NOTES

https://github.com/nabitllc/todero/blob/master/releases/v{VERSION}.md
...
- The opening and closing `:todero: :todero: :todero:` bookends are
  part of the brand — keep them.
- Name the install channels somewhere in the post: `npx todero@latest`
...
- **First person, conversational.** "I want to meet companies using Todero",
  "what's on my mind", "if that's you let me know". Not "Todero is excited
  to announce".
...
- **"What's on my mind"** is dotta's personal/strategic thinking — docs gaps,
  ...
  invitations ("if you've ever wanted to write about how you use Todero,
...
- **The "In Summary" mission line** evolves slowly. Use the most recent
  ...
  - "Todero will be _the_ control plane for AI agents in **every** company."
- **Closing tagline** is always `ITS TIME TO CLIP :todero: :todero:
  :todero:`. Keep it.
...
2. Resolve the parent `release` case with key `todero-release:vYYYY.MDD.P`.
...
POST /api/companies/:companyId/cases
{
  ...
  "key": "todero-release:vYYYY.MDD.P:tweet-storm",
  "title": "Todero vYYYY.MDD.P tweet storm",
  "summary": "Social announcement thread for Todero vYYYY.MDD.P.",
  "status": "in_review",
  ...
  "fields": {
    ...
    "links": {
      "release_notes": "https://github.com/nabitllc/todero/blob/master/releases/vYYYY.MDD.P.md",
      "official_account": "https://x.com/toderoing"
    },
    "review": {
...
{
  "title": "Todero vYYYY.MDD.P tweet storm body",
  "format": "markdown",
...
```
CLIPPERS! v2026.403.0 has dropped!! :todero: :todero: :todero:
...
:thumbsup:  **Feedback and evals** - you can now vote :thumbsup: / :thumbsdown: on your agent's responses. If you choose to share your traces with me, I'll use it to make Todero better. In either case you can export locally for your own org's learning
:page_with_curl:  **Document revisions** - you can now restore old versions of your documents
:ping_pong:  **Telemetry** - this version has anonymized telemetry that helps me better understand the basic uses of Todero (adapters and so on) - if you hate that, just it disable with `DO_NOT_TRACK=1` or `PAPERCLIP_TELEMETRY_DISABLED=1` environment variables
:construction_worker: **Execution Workspaces (experimental)** - Todero is not a "code review" tool, but I have been finding worktrees are important for certain projects. Enable it in experimental settings
...
I've been doing my part to spread the word about Todero
...
* [Nevo made $76k in march](https://x.com/dotta/status/2039406772859920758) after using Todero to automate his marketing
* [Lewis Jackson](https://x.com/WhatSayLew/status/2039810227394978158) said 34 agents were already operating his trading firm through Todero and called it his "holy s***" AI moment.
* [Neal Kotak](https://x.com/nkotak1/status/2039582439459209638) said Todero already runs most of Roominary for him and praised how strong the product is.
* [Sam Woods](https://x.com/samwoods/status/2039039305960587755) said he knows several people who moved from OpenClaw to Todero, often with Hermes in the stack, and that they love it.
* [Josh Galt](https://x.com/JoshGalt/status/2039386307219095557) called Todero the coolest agent tooling he has used and said it is finally something that just works.

## IN SUMMARY

I know there are still some rough edges, but

Todero will be *the* control plane for AI agents in **every** company.

and I think we're moving at a pretty good clip :todero: :todero: :todero:

FULL RELEASE NOTES HERE

https://github.com/nabitllc/todero/releases/tag/v2026.403.0
...
```
:todero: :todero: :todero: CLIPPERS!!! v2026.416.0 IS OUT :todero: :todero: :todero:
...
:no_smoking: Blocker dependencies - first-class "wake on blocker resolved" which means now you can have "task graphs" that depend on one another and it's enforced by Todero
...
And then a million fixes around ux, details, keyboard shortcuts, bug fixes, security fixes, etc. Really you should read the [full release notes here](https://github.com/nabitllc/todero/releases/tag/v2026.416.0)
...
* **Multi-human users** - in the last stages of testing, Todero is better with teams
* **Memory Infrastructure** - your agents will remember everything about yoru business
* **Sandbox execution** - run your agents anywhere

## What's on my mind

* I want to meet with companies who are using Todero in their business - if that's you let me know
* We need more Todero tutorials, defaults, and education - thanks to @aronprins for his work in this area already!
...
* We're adding better support for *knowledge (wikis & files)*, *artifacts*, and *work product* in Todero soon.

## PRESS

* **AI Engineer Europe Tutorial** - I gave a tutorial for AIE. If someone is looking for a basics ABC of Todero [you can send them this](https://x.com/dotta/status/2044575580264316931)
* **AI Club Chicago** - JB gave a talk on Todero [at AI Tinkerers in Chicago](https://x.com/developwithJB/status/2044281068778316268) !

## IN SUMMARY

PAPERCLIP WILL BE THE DEFAULT AGENT-MANAGEMENT TOOL FOR EVERY COMPANY

If there's anything I can do to help you and your company use Todero, hit me up. Until then, enjoy the new release

ITS TIME TO CLIP :todero: :todero: :todero:

FULL RELEASE NOTES

https://github.com/nabitllc/todero/releases/tag/v2026.416.0
...
```
:todero: :todero: :todero: CLIPPERS!!! v2026.427.0 IS OUT :todero: :todero: :todero:

THIS IS THE OFFICIAL TWITTER FOLLOW IT: https://x.com/toderoing
...
* **Longer-range planning and execution** - Todero will support longer and longer tasks and work until it's done
* **Secrets Service v2** - an important prereq for Todero cloud
...
* **Todero Cloud** - will be a critical unlock for us, but even the shared team story needs developed more - *where should the work be done* and *where are the outputs stored* and *how do we surface them to users*? Each of these questions are a core Todero service that needs developed
* **Todero Bench** - In the vein of SWE-Bench I've started an internal benchmark for Todero - we have to be able to measure that our changes are improving the system and not regressing
* **Todero Connections Store** - connecting to Github, Slack, Google Docs, and the hundreds of other services we use every day should be easy, secure, and configurable per agent and team

## Press

I met with the [Wisemen about Todero](https://x.com/dotta/status/2045146539534827998)

## WHAT I NEED FROM YOU

FOLLOW THIS TWITTER ACCOUNT: https://x.com/toderoing - that's the only official one, report any others

## In Summary

PAPERCLIP IS THE AI ORCHESTRATOR FOR HUMANS TO ACCOMPLISH 100x MORE WORK

Every single person will be managing a team of a dozen, or a hundred, or a thousand agents and Todero will be the default tool to manage it all.

ITS TIME TO CLIP :todero: :todero: :todero:

FULL RELEASE NOTES

https://github.com/nabitllc/todero/blob/master/releases/v2026.427.0.md
...
6. Closing tagline is `ITS TIME TO CLIP :todero: :todero: :todero:`

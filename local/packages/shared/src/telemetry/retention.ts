 ...
 *
 * Defines the retention class for each Todero telemetry event and the
 ...
 * that are not part of the shared generated `ToderoEventName` type. When an
 ...
 *   External-system event (Codex CLI) — not yet in ToderoEventName.

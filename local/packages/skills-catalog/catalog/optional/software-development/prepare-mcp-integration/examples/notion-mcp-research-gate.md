...
> Research Notion's hosted MCP server and prepare it for Todero. Start from
> the vendor documentation URL. Do not build the connector until I approve the
> research.

## Application

1. Read the current `todero-content/integrations/README.md` and integration
...
4. Open a research-only `todero-content` PR containing the planning package
...
6. Stop with the issue in review. No Todero App branch exists yet.

## Gate Output

```text
Research PR: https://github.com/nabitllc/todero-content/pull/123
...
After acceptance, create one isolated Todero App worktree and PR for

 ...
 * account — NOT as the Todero app/agent account.
 *
 * Usage:
 *   todero-tailscale-https-broker            # run the broker
 *   todero-tailscale-https-broker --doctor   # read-only preflight, no mutation
 */

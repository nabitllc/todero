...
import { copyTextToClipboard, usePluginData, usePluginToast } from "@todero/plugin-sdk/ui";
...
const FILE_SIDEBAR_WIDTH_STORAGE_KEY = "todero.workspace-diff.files-sidebar-width";

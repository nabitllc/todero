import type { PluginLauncherRegistration } from "@todero/plugin-sdk";

export const PLUGIN_ID = "todero-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".todero-kitchen-sink-demo.txt",
} as const;

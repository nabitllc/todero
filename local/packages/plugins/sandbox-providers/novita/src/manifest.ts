...
const PLUGIN_ID = "todero.novita-sandbox-provider";
...
const manifest: PaperclipPluginManifestV1 = {
  ...
  description:
    "Sandbox provider plugin that provisions Novita Agent Sandbox environments for Todero agent runs.",
  author: "Novita AI",
      ...
      configSchema: {
        ...
        properties: {
          apiKey: {
            ...
            format: "secret-ref",
            description:
              "Environment-specific Novita API key. Paste a key or an existing Todero secret reference; saved environments store pasted values as company secrets. Falls back to NOVITA_API_KEY if omitted.",
          },
          domain: {
            type: "string",
            description:
          ...
          requestedCwd: {
            type: "string",
            default: "/home/user/todero-workspace",
          ...
          reuseLease: {
            ...
            default: false,
            description:
              "Pause and later resume the sandbox across Todero runs instead of killing it on release.",
          },
        },
      },
    },

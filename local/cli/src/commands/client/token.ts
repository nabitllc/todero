...
import { createAgentKeySchema, createBoardApiKeySchema, type Agent } from "@todero/shared";
import {
...
export function registerTokenCommands(program: Command): void {
  const token = program.command("token").description("Manage Todero API tokens");

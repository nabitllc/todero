...
import type { Agent, Issue, IssueComment } from "@todero/shared";
import { addIssueCommentSchema, createIssueSchema } from "@todero/shared";
import {
...
export function registerPromptCommands(program: Command): void {
  addCommonClientOptions(
    program
      ...
      .description("Create/update Todero work for an agent using an agent API key")
  ...
  addCommonClientOptions(
    agent
      .command("prompt")
      .description("Create/update Todero work using an agent persona")
      .argument("<prompt...>", "Prompt text")
  ...
  addCommonClientOptions(
    board
      .command("prompt")
      .description("Create/update Todero work for an agent using board auth")

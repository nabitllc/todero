...
Agent run writes auto-link the run's issue when Todero can resolve it from
the run JWT or `X-Todero-Run-Id`. Creation/upsert writes use `origin`; later
...
{
  "caseType": "blog_post",
  "key": "todero-cases-launch",
  "title": "Introducing Todero Cases",
  "summary": "Blog post explaining the cases surface for agent outputs.",
  "status": "in_progress",
  "fields": {
    "slug": "todero-cases-launch",
...
{
  "caseType": "image_assets",
  "key": "todero-cases-launch:image-assets",
  "title": "Image assets for Introducing Todero Cases",
  "parentCaseId": "parent-case-uuid",
  "status": "in_progress",
  "fields": {
    "slug": "todero-cases-launch",
...

{
  ...
  "fields": {
    "slug": "todero-cases-launch",
    "target_audience": "AI company operators",
    "publish_url": "https://example.com/blog/todero-cases-launch"
  }
}
```

...
const storybookRepoRoot = "~/todero";
const storybookWorkspaceRoot = `${storybookRepoRoot}/.todero/workspaces`;
const storybookWorktreeRoot = `${storybookRepoRoot}/.todero/worktrees`;
...
export const storybookAgents: Agent[] = [
  {
    ...
    status: "running",
    reportsTo: "agent-cto",
    capabilities: "Ships full-stack Todero product tasks, Storybook coverage, and verification.",
...
export const storybookGoals: Goal[] = [
  {
    ...
    companyId: "company-storybook",
    title: "Build Todero",
    description: "Make Todero the control plane operators trust for autonomous AI companies.",
    level: "company",
    status: "active",
    parentId: null,
...
const storybookWorkspaceRuntime = {
  commands: [
    ...
    },
    {
      ...
      name: "UI typecheck",
      kind: "job",
      command: "pnpm --filter @todero/ui typecheck",
      cwd: ".",
    },
  ],
};
  ...
  },
  {
    ...
    runtimeServices: [
      createRuntimeService({
        ...
        cwd: null,
        port: 4173,
        url: "https://todero-docs-preview.vercel.app",
...
function createProject(overrides: Partial<Project> = {}): Project {
  ...
  return {
    ...
    codebase: {
      ...
      managedFolder: ".todero/worktrees/storybook",
...
export const storybookContinuationHandoff: IssueDocument = {
  ...
  body: [
    ...
    "",
    "Important files: `ui/storybook/stories/issue-management.stories.tsx` and `ui/storybook/fixtures/toderoData.ts`.",
  ].join("\n"),
...
export const storybookSecretProviderDiscoveryPreview: SecretProviderConfigDiscoveryPreviewResult = {
  ...
  warnings: ["Skipped 1 Todero-managed AWS secret from a different deployment namespace."],
  candidates: [
    {
      provider: "aws_secrets_manager",
      displayName: "AWS production",
      ...
      samples: [
        {
          name: "todero/prod-use1/company-storybook/openai_api_key",
          hasKmsKey: true,
          tagKeys: ["todero:managed-by", "todero:environment", "todero:provider-owner"],
        },
      ],
      signals: {
        namespace: "prod-use1",
...
export const storybookSecrets: CompanySecret[] = [
  ...
  },
  {
    ...
    externalRef: "arn:aws:secretsmanager:us-east-1:123456789012:secret:todero/prod/aws-deploy-AbCdEf",
    providerConfigId: null,
    providerMetadata: null,
    latestVersion: 2,
  ...
  providers: [
    {
      ...
      warnings: [] as string[],
      backupGuidance: ["Backup ~/.todero/instances/default/secrets/key separately from the database."],
    },
    {

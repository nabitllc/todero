...
import { storybookAgents, storybookProjects, storybookIssues } from "../fixtures/toderoData";
...
function SearchStories() {
  return (
    <div className="todero-story">
      <main className="todero-story__inner max-w-[1320px] space-y-6">
        <section className="todero-story__frame p-6">
          <div className="todero-story__label">Search</div>
        ...
        <section className="todero-story__frame overflow-hidden">
          <div className="todero-story__title-block">
            <div className="todero-story__label">/search</div>
        ...
        <section className="todero-story__frame overflow-hidden">
          <div className="todero-story__title-block">
            <div className="todero-story__label">/search · screen 3</div>
        ...
        <section className="todero-story__frame overflow-hidden">
          <div className="todero-story__title-block">
            <div className="todero-story__label">/search · screen 1</div>
        ...
        <section className="todero-story__frame overflow-hidden">
          <div className="todero-story__title-block">
            <div className="todero-story__label">/search · screen 4</div>
        ...
        <section className="todero-story__frame overflow-hidden p-4">
          <div className="todero-story__title-block">
            <div className="todero-story__label">Match-source chips</div>
        ...
        <section className="todero-story__frame overflow-hidden p-4">
          <div className="todero-story__title-block">
            <div className="todero-story__label">Cmd+K palette</div>
        ...
        <section className="todero-story__frame overflow-hidden p-4">
          <div className="todero-story__title-block">
            <div className="todero-story__label">Search result row</div>

...
import type { Agent, CompanySecret, EnvBinding, Project, RoutineVariable } from "@todero/shared";
...
import { createIssue, storybookAgents } from "../fixtures/toderoData";
...
See [the implementation notes](https://github.com/nabitllc/todero).`;
...
const adapterSchema: JsonSchemaNode = {
  ...
  properties: {
    ...
    apiKey: {
      ...
      title: "API key",
      format: "secret-ref",
      description: "Stored with the active Todero secret provider.",
    },
    concurrency: {
      type: "integer",
...
const validAdapterValues = {
  ...
  allowedCommands: ["pnpm --filter @todero/ui typecheck", "pnpm build-storybook"],
...
const storybookProject: Project = {
  ...
  goals: [{ id: "goal-company", title: "We're building Todero" }],
  name: "Board UI",
  ...
  codebase: {
    ...
    defaultRef: "master",
    repoName: "todero",
    localFolder: "/Users/dotta/todero",
    managedFolder: "todero",
    effectiveLocalFolder: "/Users/dotta/todero",
    origin: "local_folder",
  },
  workspaces: [],
    ...
    <StoryShell>
      <section className="todero-story__frame p-6">
        <div className="flex flex-wrap items-start justify-between gap-5">
          <div>
            <div className="todero-story__label">Forms and editors</div>
            <h1 className="mt-2 text-3xl font-semibold tracking-tight">Todero form controls under realistic state</h1>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Fixture-backed stories for Todero form controls, markdown editors, inline editors, schedule controls, runtime-variable dialogs, and selection pickers.",
      },
    },
  },
} satisfies Meta;

...
import type { Project, SharedWorkspaceConcurrency } from "@todero/shared";
            ...
            */}
            {hideHostPaths ? (
              codebase.origin === "managed_checkout" ? (
                <div className="text-(length:--text-micro) text-muted-foreground">Todero-managed folder.</div>
              ) : null
            ) : (
              <div className="space-y-1">
            ...
            {hasAdditionalLegacyWorkspaces && (
              <div className="text-(length:--text-micro) text-muted-foreground">
                Additional legacy workspace records exist on this project. Todero is using the primary workspace as the codebase view.
              </div>
            )}

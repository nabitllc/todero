...
export const PROJECT_ORDER_UPDATED_EVENT = "todero:project-order-updated";
export const PROJECT_SORT_MODE_UPDATED_EVENT = "todero:project-sort-mode-updated";
const PROJECT_ORDER_STORAGE_PREFIX = "todero.projectOrder";
const PROJECT_SORT_MODE_STORAGE_PREFIX = "todero.projectSortMode";

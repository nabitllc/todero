...
export const AGENT_ORDER_UPDATED_EVENT = "todero:agent-order-updated";
export const AGENT_SORT_MODE_UPDATED_EVENT = "todero:agent-sort-mode-updated";
const AGENT_ORDER_STORAGE_PREFIX = "todero.agentOrder";
const AGENT_SORT_MODE_STORAGE_PREFIX = "todero.agentSortMode";

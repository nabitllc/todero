...
name: design-guide
description: >
  Todero UI design system guide for building consistent, reusable frontend
...
Todero's UI is a professional-grade control plane — dense, keyboard-driven, dark-themed by default. Every pixel earns its place.
...
2. **Custom composites** (`ui/src/components/`) — StatusBadge, EntityRow, MetricCard, etc. These capture Todero-specific design language.

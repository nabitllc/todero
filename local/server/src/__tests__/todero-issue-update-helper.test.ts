...
// End-to-end coverage for scripts/todero-issue-update.sh: the helper must
...
const HELPER_PATH = path.resolve("scripts/todero-issue-update.sh");
...
describe("todero issue update helper", () => {

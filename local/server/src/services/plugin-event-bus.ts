/**
 * PluginEventBus — typed in-process event bus for the Todero plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@todero/shared";
import type { PluginEvent, EventFilter } from "@todero/plugin-sdk";

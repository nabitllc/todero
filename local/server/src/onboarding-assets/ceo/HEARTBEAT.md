...
Run this checklist on every heartbeat. This covers both your local planning/memory work and your organizational coordination via the Todero skill.
...
- For scoped issue wakes, Todero may already checkout the current issue in the harness before your run starts.
...
- Use `todero-create-agent` skill when hiring new agents.
...
- Always use the Todero skill for coordination.
- Always include `X-Todero-Run-Id` header on mutating API calls.

...
- Running a Python script that calls the Todero API
...
1. Todero spawns the configured command as a child process
2. Standard Todero environment variables are injected (`PAPERCLIP_AGENT_ID`, `PAPERCLIP_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Todero API and perform work.

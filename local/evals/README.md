...
Eval framework for testing Todero agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Todero heartbeat skill:

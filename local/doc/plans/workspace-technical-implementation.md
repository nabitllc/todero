...
This document translates [workspace-product-model-and-work-product.md](/Users/dotta/todero-subissues/doc/plans/workspace-product-model-and-work-product.md) into an implementation-ready engineering plan.
...
- `local`
  - Todero may create host-local worktrees, processes, and paths
- `cloud`
  - Todero should assume no durable host-local execution workspace management
...
- `provider text not null`
  - `todero | github | vercel | s3 | custom`

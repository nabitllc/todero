...
- installed adapter list for this Todero instance
...
## 8. New Skill: `todero-create-agent`

Create new skill directory:

- `skills/todero-create-agent/SKILL.md`
- `skills/todero-create-agent/references/api-reference.md`
...
Also update `skills/todero/SKILL.md` to reference this skill for hiring workflows.
...
- `todero-create-agent` skill + docs updates

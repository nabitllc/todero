...
import { agentWakeupRequests, agents, heartbeatRuns, issues } from "@todero/db";
import type { IssueCommentMetadata, IssueCommentPresentation, RunLivenessState } from "@todero/shared";
...
export function buildSuccessfulRunHandoffInstruction(input: {
  ...
  return [
    ...
    "",
    "## Your options",
    "Choose **exactly one** outcome and perform the matching Todero action:",
    "",

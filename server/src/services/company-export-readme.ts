 ...
 */
import type { CompanyPortabilityManifest } from "@todero/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Todero](https://todero.vercel.app)");
  lines.push("");
  ...
  // Footer
  lines.push("---");
  lines.push(`Exported from [Todero](https://todero.vercel.app) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");

 ...
 *   never executes on the tenant's Todero-operated container. Unlike
 ...
 *   rather than executing on Todero compute.
 */
...
export function evaluateExecutionAllowlist(
  ...
  // agent code must never run in-process / on the tenant's Todero

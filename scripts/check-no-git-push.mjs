 ...
 *
 * Opt-in mechanism: a line containing `todero:allow-git-push` (typically
 * inside a `// todero:allow-git-push: <reason>` comment on the line itself
...
export const ALLOW_MARKER = "todero:allow-git-push";

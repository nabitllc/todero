...
const STORIES = [
  {
    id: "todero-source-issue-recovery--recovery-action-card-states",
    label: "card-states",
  },
  {
    id: "todero-source-issue-recovery--inbox-row-chips",
    label: "inbox-rows",
  },
  {
    id: "todero-source-issue-recovery--blocker-notice-recovery-indicators",
    label: "blocker-notice",
  },
  {
    id: "todero-source-issue-recovery--active-run-panel-recovery-chips",

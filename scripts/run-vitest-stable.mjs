...
const nonServerProjects = [
  "@todero/shared",
  "@todero/skills-catalog",
  "@todero/db",
  "@todero/adapter-utils",
  "@todero/adapter-claude-local",
  "@todero/adapter-codex-local",
  "@todero/adapter-grok-local",
  "@todero/adapter-openclaw-gateway",
  "@todero/adapter-opencode-local",
...
const generalWorkspacesAProjects = ["@todero/ui", "todero"];

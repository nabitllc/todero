...
3. **Domain tier** — match-chip tokens `--chip-match-*`, annotation highlights `--todero-doc-annotation-highlight-*`, plus motion/typography tokens.

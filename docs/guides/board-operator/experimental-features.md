...
summary: What Todero experimental features mean for board operators
---
...
When a feature is marked experimental, Todero is still evaluating the product shape and implementation details.
...
- Todero does not promise compatibility, rollback, migration, or long-term support for experimental features.
...
- See the repo CLI reference in [`doc/CLI.md`](https://github.com/nabitllc/todero/blob/main/doc/CLI.md) when working from the repository.

...
Manage companies within your Todero instance.
...
Company logo uploads use the normal Todero attachment size limit.
...
| `logoUrl` | string | Optional Todero asset content path for the stored logo image |

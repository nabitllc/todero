...
const MOCK_CARDS: DiscoveryCard[] = [
  {
    key: "nabitllc/todero/todero-dev",
    skillId: "s-dev",
    catalogRef: null,
    name: "todero-dev",
    slug: "todero-dev",
    author: "Todero",
    version: "v2.4.1",
    tagline: "Run and repair local Todero workspaces.",
    description: "Develop and operate a local Todero instance.",
  ...
  {
    key: "nabitllc/todero/security-review",
    skillId: "s-sec",
    catalogRef: null,
  ...
  {
    key: "nabitllc/todero/diagnose-why-work-stopped",
    skillId: "s-diag",
    catalogRef: "c-diag",

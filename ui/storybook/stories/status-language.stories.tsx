...
import { AGENT_STATUSES, ISSUE_PRIORITIES, ISSUE_STATUSES } from "@todero/shared";
import type {
...
import { createIssue } from "../fixtures/toderoData";
    ...
    <div className="todero-story">
      <main className="todero-story__inner space-y-6">
        <section className="todero-story__frame p-6">
          <div className="todero-story__label">Language</div>

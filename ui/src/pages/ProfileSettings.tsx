...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@todero/shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in Todero file storage for ${selectedCompany.name}.`
    : "Select an organization to upload an avatar into Todero storage.";

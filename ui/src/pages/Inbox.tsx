...
import { deriveOriginatingActor, INBOX_MINE_ISSUE_STATUS_FILTER } from "@todero/shared";
...
import type { Approval, HeartbeatRun, Issue, JoinRequest } from "@todero/shared";
import {
          ...
          <span className="min-w-0 flex-1">
            <span className="line-clamp-2 text-sm font-medium sm:truncate sm:line-clamp-none">
              {issue ? (
                ...
                <>A turn failed{linkedAgentName ? ` — ${linkedAgentName}` : ""}</>
              )}
            </span>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="failed_runs">Failed turns</SelectItem>

import { checkOAuthEndpointUrl, oauthEndpointUrlRejectionMessage } from "@todero/shared";
...
export function resolveAuthorizationTarget(value: string | null | undefined): AuthorizationTarget {
  ...
  const check = checkOAuthEndpointUrl(value ?? null, {
    ...
    // Todero's own origin: a first-party authorization endpoint (the smoke-lab

import type { PipelineCaseLiveness } from "@todero/shared";
...
const AUTO_RETRY_NOTE =
  "Todero retries automatically once the blocker clears — you don't need to move the item by hand.";
...
const NO_ACTION_PATH_BODY =
  "Todero can't see anything to work on next here — no automation, retry, blocker, or review. " +
  ...
  switch (liveness.reason) {
    ...
    case "permission_preflight_failed":
      return {
        ...
        retryLabel: "",
        helperNote:
          "Grant the access above to the configured responsible, then Todero retries automatically.",
      };

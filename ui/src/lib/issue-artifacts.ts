import type { IssueAttachment, IssueDocumentSummary, IssueWorkProduct } from "@todero/shared";
import { getAttachmentArtifactWorkProductMetadata } from "@todero/shared";
...
/**
 * Attachment ids owned by valid attachment-backed Todero work products.

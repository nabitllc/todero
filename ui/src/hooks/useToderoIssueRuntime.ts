...
export interface ToderoIssueRuntimeReassignment {
  assigneeAgentId: string | null;
  assigneeUserId: string | null;
}

export interface ToderoIssueRuntimeSendOptions {
  body: string;
  reopen?: boolean;
  reassignment?: ToderoIssueRuntimeReassignment;
}

interface UseToderoIssueRuntimeOptions {
  messages: readonly ThreadMessage[];
  isRunning: boolean;
  onSend: (options: ToderoIssueRuntimeSendOptions) => Promise<void>;
...
export function useToderoIssueRuntime({
  messages,
  isRunning,
  onSend,
  onCancel,
}: UseToderoIssueRuntimeOptions) {

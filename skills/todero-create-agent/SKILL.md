...
description: >
  Create new agents in Todero with governance-aware hiring. Use when you need
  to inspect adapter configuration options, compare existing agent configs,
  draft a new agent prompt/config, and submit a hire request.
---

# Todero Create Agent Skill
...
### 2. Discover adapter configuration for this Todero instance
...
`skills/todero-create-agent/references/agent-instruction-templates.md`

Generic fallback for no-template hires:
`skills/todero-create-agent/references/baseline-role-guide.md`
...
- for coding or execution agents, include the Todero execution contract: start actionable work in the same heartbeat; do not stop at a plan unless planning was requested; leave durable progress with a clear next action; use child issues for long or parallel delegated work instead of polling; mark blocked work with owner/action; respect budget, pause/cancel, approval gates, and company boundaries
...
`skills/todero-create-agent/references/draft-review-checklist.md`
...
- Template index and how to apply a template: `skills/todero-create-agent/references/agent-instruction-templates.md`
- Individual role templates: `skills/todero-create-agent/references/agents/`
- Generic baseline role guide (no-template fallback): `skills/todero-create-agent/references/baseline-role-guide.md`
- Pre-submit draft-review checklist: `skills/todero-create-agent/references/draft-review-checklist.md`
- Endpoint payload shapes and full examples: `skills/todero-create-agent/references/api-reference.md`

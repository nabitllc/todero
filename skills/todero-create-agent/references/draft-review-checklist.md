...
- [ ] The first paragraph points at the Todero skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the Todero execution contract verbatim:
...
- [ ] Adapter config matches this Todero instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
